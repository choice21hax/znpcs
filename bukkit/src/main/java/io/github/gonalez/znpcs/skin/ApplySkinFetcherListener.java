...
public abstract class ApplySkinFetcherListener implements SkinFetcherListener {
  ...
  public void onComplete(GameProfile gameProfile) {
    ...
    if (textureProperty != null) {
      NPCSkin skin = NPCSkin.forValues(textureProperty.getValue(), textureProperty.getSignature());
      // Skin/profile retrieval runs off-thread; modifying viewers and sending packets must not.
      ServersNPC.SCHEDULER.runTask(() -> npc.changeSkin(skin));
    }
  }
}
